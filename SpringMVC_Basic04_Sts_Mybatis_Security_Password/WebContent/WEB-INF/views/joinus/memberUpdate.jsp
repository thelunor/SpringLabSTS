		...
		<div id="join-form" class="join-form margin-large">
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="userid" readonly="readonly" value="${member.userid}" />
					<input id="btnCheckUid" class="button" type="button" value="중복확인" hidden="hidden" />
				</dd>
			</dl>
			<dl class="join-form-row">
			...
			<!-- <dl class="join-form-row birthday">
				...
				<dd class="join-form-data">
					<span>
						...
						<input type="text" id="month" />월 <input type="text" id="day" />일
						<input type="hidden" name="Birth" id="Birth" /></span>
					<span class="moon">
