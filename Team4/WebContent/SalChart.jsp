...
<body data-spy="scroll" data-target=".navbar-collapse">
	...
	<div class="culmn">
		...
		<nav
			...
			<jsp:include page="./WEB-INF/admin/Admin_top.jsp"></jsp:include>
		...
		<section id="id" class="about roomy-100">
			<div class="container">
				...
				<br>
					<hr>
					<div class="row" style="float:center; width : 100%;  padding-left: 200px;">
						<div class="col-lg-12">
						<jsp:include page="./WEB-INF/charts/Bchart.jsp"></jsp:include>
						</div>
					</div>
					</div>
				</div>
