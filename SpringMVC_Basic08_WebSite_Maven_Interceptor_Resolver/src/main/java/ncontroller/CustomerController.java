...
public class CustomerController {
	...
	*/
	...
	public String listBoard(String pg, String f, String p, Model model){
		...
		System.out.println("CustomerController listBoard 메서드 끝");
	...
	public String detailBoard(String seq, Model model){
		...
		//ModelAndView 써도 무관				
		//return "noticeDetail";
		System.out.println("CustomerController detailBoard 메서드 끝");
	...
	public String writeBoard() {
		//return "noticeReg";
		System.out.println("CustomerController writeBoard 메서드 끝");
	...
	public String writeBoardOk(Notice notice, HttpServletRequest request) {
		...
		System.out.println("CustomerController writeBoardOk 메서드 끝");
	...
	public String deleteBoard(String seq) {
		...
		System.out.println("CustomerController deleteBoard 메서드 끝");
		return "redirect:notice.htm";
	}
	...
	public String editboard(String seq, Model model) {
		...
		//return "noticeEdit";
		System.out.println("CustomerController editboard 메서드 끝");
	...
	public String editboardOk(Notice notice,HttpServletRequest request) {
		...
		System.out.println("CustomerController editboardOk 메서드 끝");
